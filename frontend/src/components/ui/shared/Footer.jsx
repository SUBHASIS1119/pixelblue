...
const Footer = () => {
  return (
    <div>
       <footer className="bg-white text-black border-2 border-gray-200 shadow-xl py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold mb-4 ">Pixel<span className="text-[#6A38C2]">Blue</span></h3>
            <p>
              We provide the best services to help you grow. 
        ...
        <div className="mt-8 border-t border-gray-700 pt-4 text-center">
          <p>&copy; {new Date().getFullYear()} Pixel Blue. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
    </div>
